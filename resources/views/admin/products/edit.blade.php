...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('url', old('url',$products->url), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('shops_id', 'store*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::select('shops_id', $shops, old('shops_id',$products->shops_id), array('class'=>'form-control')) !!}
